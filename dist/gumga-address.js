...
var GumgaAddressModalController = function GumgaAddressModalController($scope, factoryData, GumgaAddressService, $uibModalInstance, apiSearchCep, $gumgaAddress) {
...
function AddressDirective(GumgaAddressService, $http, $compile, $uibModal, $timeout, $injector, $gumgaAddress) {
  ...
  return {
    ...
    link: function link(scope, elm, attrs, ctrl) {
      ...
      scope.checkFieldRequired = function (field) {
        ...
        var forms = gumgaForms.filter(function (form) {
          return form.element[0] == angular.element('form[gumga-form]')[0];
        });
